...
int main(void) {
  ...
  spherelistadd(&world, sp(v3(0, 0, -1), 0.5, center));
  spherelistadd(&world, sp(v3(-1, 0, -1), 0.5, left));
  spherelistadd(&world, sp(v3(-1, 0, -1), -0.4, left));
  spherelistadd(&world, sp(v3(1, 0, -1), 0.5, right));
